...
SceneManager::SceneManager(ShaderManager *pShaderManager)
{
	...
	//Intialized for the texture collection
	for (int i = 0; i < 16; i++)
	{
...
void SceneManager::DefineObjectMaterials()
{
	...
	silverMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	silverMaterial.ambientStrength = 0.3f;
	silverMaterial.diffuseColor = glm::vec3(0.2f, 0.2f, 0.2f);
	silverMaterial.specularColor = glm::vec3(0.5f, 0.5f, 0.5f);
	silverMaterial.shininess = 30.0;
	silverMaterial.tag = "sunkiss";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", -10.0f, 14.0f, 8.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 10.0f, 14.0f, 8.0f);
...
{
	//Will load texture for 3D scene
	LoadSceneTextures();
	//Will define materials used for 3D scene
	DefineObjectMaterials();
	//Will add light sources to 3D scene
	SetupSceneLights();
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 10.0f, -7.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(7.0f, 0.01f, 1.0f);
	...
	//Tea in Mug Cylinder
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.9f, 7.01f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(8.0f, 3.8f, 2.0f);
	...
	//************************************************************************
	//Box for Laptop Screen
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(6.5f, 0.5f, 14.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 0.3f, 2.6f);
	...
	//Cone for Kiss #1
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.70f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 0.01f, 4.0f);
	...
	//SetShaderColor(1, 1, 0.9, 0.7);
	SetShaderTexture("tinfoil");
	SetTextureUVScale(2.0, 2.0);
	SetShaderMaterial("sunkiss");
	...
	//Kiss #1 Plane Mesh
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 1.0f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 0.9f, 4.0f);
	...
	//SetShaderColor(1, .5, .7, 0.8);
	SetShaderTexture("kisstag");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 0.01f, 2.0f);
	...
	//SetShaderColor(1, 0.21, 0.5, 1);
	SetShaderTexture("pinkkiss");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("sunkiss");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 0.9f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(9.0f, 0.01f, 3.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(9.0f, 0.9f, 3.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 0.01f, 1.0f);
	...
	//SetShaderColor(0.45, 1, 0.5, 1);
	SetShaderTexture("lemonlime");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("glass");
	...
	//Cylinder for Candle Interior
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.75f, 3.51f, 2.0f);
	...
	//************************************************************************
	//Cylinder wick for Candle
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.08f, 0.25f, 0.50f);
	...
	//SetShaderColor(1, 0.2, 1, 1);
	SetShaderTexture("wick");
	SetTextureUVScale(1.0, 1.0);
